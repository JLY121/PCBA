...
def eval_linear(args, model):
    ...
    model.eval()
    # ----加载测试数据集-----
    testset = get_dataset(args, train=False)                                              #-------重新生成测试数据集-----
    ...
    for target_id in target_ids:
        ...
        # ===对选定神经元的激活值进行扰动（从0到3，步长0.1倍均值），观察model_tail输出的变化
        ...
        # 使用线性回归（LinearRegression）拟合扰动与输出变化的关系，计算R²分数（r2_score）评估线性性
...
def main_eval_linear(model):
    parser = argparse.ArgumentParser(description='Process input arguments.')
    parser.add_argument('--gpu', default='0', help='gpu id')
    parser.add_argument('--datadir', default='/Data/JLY/A3FL/main/datasets', help='root directory of data')
    ...
    # -----添加参数-----
    parser.add_argument('--num_classes', type=int, default=10, help='class nums of datasets')
    parser.add_argument('--in_channels', type=int, default=3, help='channels of datasets images')
    parser.add_argument('--trigger_size', default=5, help='size of trigger pattern')
    parser.add_argument('--model_path', default='/Data/JLY/A3FL/saved/benign_new/cifar10_1900_avg.pt' , help='model path')
    parser.add_argument('--trigger_path', default='/Data/JLY/A3FL/saved/trigger/trigger_after_train.png', help='trigger path')
